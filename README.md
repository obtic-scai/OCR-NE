...
The ultimate goal was not the correction _per se_, but the valorisation and the exploitation of the corpus via the named entity recognition (NER) method, in order to determine the impact of the spellchecking libraries on the NER task.
